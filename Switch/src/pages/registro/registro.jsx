...
export function RegistroPage() {
    const [formData, setFormData] = useState({nombre: '', apellido: '', email: '', usuario: '', contrasena: '', aceptarTerminos: false,});
    ...
    const handleSubmit = (e) => {e.preventDefault();
        ...
        registrarUsuario(formData)
            .then((usuario) => {
                ...
                setFormData({nombre: '', apellido: '', email: '', usuario: '', contrasena: '', aceptarTerminos: false,
                });
            })
                ...
                <div className="registro-form">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-row">
                            ...
                            <div className="input-group  col-6">
                                <input type="text" name="apellido" className="form-control input_user" required placeholder="Apellido" value={formData.apellido} onChange={handleChange}/>
                            </div>
                        </div>
                        <div className="form-row">
                        ...
                        <div className=" aceptar-terminos">
                            <input type="checkbox" name="aceptarTerminos" checked={formData.aceptarTerminos} onChange={handleCheckboxChange}/>
